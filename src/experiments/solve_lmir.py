...
out_path = '/Users/qingquanli/Documents/Seafile/CIKM_mjjd/data/predictions/lmir_top100.json'
...
for qid in tqdm(test_querys):
    ...
    sim = lmodel.jelinek_mercer(query_cutted)
    # print(sim)
    # print(len(sim))
    # break
...
json.dump(lmir_top100, out_file)
